...
<body style="background-color: #f1f4f7">
			...
			<div class="row">
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 3px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05); box-shadow: 0 1px 1px rgba(0,0,0,.05)">
					<div class="row">
						<div class="col-lg-12">
							<br/>
							<center><img src="libs/images/KKSP.png" width="120" height="120"></center>
							<h2 class="text-center">Sistem Informasi Pengajuan Cuti<br/> <b>KKSP</b></h2>
						</div>
					</div><!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom footer-bottom">
		<div class="container text-center">
			<p class="text-center" style="color: #D1C4E9; margin: 0 0 5px; padding: 0"><small>Sistem Informasi Pengajuan Cuti Online KKSP</small></p>
		</div>
	</div><!-- /.footer-bottom -->
