...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online KKSP - <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>KKSP</strong></div>
			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../foto/<?php echo $res['foto_emp'] ?>" width="20px"></i>&nbsp;<?php echo ucfirst($sess_leadername); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
