...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<form class="form-horizontal" name="cuti" action="cuti_insert.php" method="POST"
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<textarea name="keterangan" class="form-control" placeholder="Keterangan" rows="3"
										required></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="kep_unit" id="kep_unit" class="form-control" required>
										...
										<?php
										$mySql = "SELECT * FROM employee WHERE hak_akses='Kepala Unit' ORDER BY nama_emp";
